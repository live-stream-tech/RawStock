...
async function seed() {
  ...
  const videos = [
    ...
    ['Jazz Trio Live Breakdown — Shinjuku 夜公演',   'Guitar Sensei TARO', 'Jazz Night Sessions',  4500,  '2d ago',   '22:10',  1500,  'https://images.unsplash.com/photo-1511379938547-c1f69419868d?w=600&h=400&fit=crop', 'https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=80&h=80&fit=crop',  null, false, 'work'],
  ...
  const sessions = [
    ['DJ KAZE',            'electronic', 'Electronic',  'ライブ配信セット構成レビュー',     'https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f?w=80&h=80&fit=crop', 'https://images.unsplash.com/photo-1514525253161-7a46d19cd819?w=300&h=200&fit=crop', '2026-04-01', '22:00', '30min', 5000, 10, 7, 4.9, 124, 'NEW'],
    ['YUKI BLAST',         'punk',       'Punk',        'ライブ本番前ボーカル最終チェック',  'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=80&h=80&fit=crop', 'https://images.unsplash.com/photo-1459749411175-04bf5292ceea?w=300&h=200&fit=crop', '2026-04-02', '19:00', '15min', 3000,  8, 5, 4.7,  67, null],
    ['Guitar Sensei TARO', 'jazz',       'Jazz Guitar', 'セットリスト最適化ミーティング',      'https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=80&h=80&fit=crop', 'https://images.unsplash.com/photo-1415201364774-f6f0bb35f28f?w=300&h=200&fit=crop', '2026-04-03', '20:00', '45min', 8000,  5, 3, 5.0,  42, 'POPULAR'],
    ['MC RYOTA',           'hiphop',     'HIP-HOP',    '現場向けMC・煽り導線クリニック',     'https://images.unsplash.com/photo-1463453091185-61582044d556?w=80&h=80&fit=crop', 'https://images.unsplash.com/photo-1571609803939-54f463c1752e?w=300&h=200&fit=crop', '2026-04-05', '21:00', '20min', 4000, 12, 9, 4.8,  89, null],
  ];
