...
const SOURCES = [
  ...
  { key: "spin", label: "SPIN", url: "https://www.spin.com/feed/" },
  { key: "louder_live_music", label: "Louder (Live music)", url: "https://www.loudersound.com/feeds/tag/live-music" },
  { key: "rollingstone_music", label: "Rolling Stone (Music)", url: "https://www.rollingstone.com/music/feed/" },
  { key: "pitchfork_news", label: "Pitchfork (News)", url: "https://pitchfork.com/feed/feed-news/rss" },
  { key: "billboard", label: "Billboard", url: "https://www.billboard.com/feed/" },
  { key: "mbw", label: "Music Business Worldwide", url: "https://www.musicbusinessworldwide.com/feed/" },
  { key: "loudwire", label: "Loudwire", url: "https://loudwire.com/feed/" },
] as const;
