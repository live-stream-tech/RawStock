...
const paidHero = StyleSheet.create({
  card: { width: SCREEN_W, height: PAID_HERO_H, position: "relative", backgroundColor: "#000" },
  thumb: { position: "absolute", top: 0, left: 0, width: SCREEN_W, height: PAID_HERO_H },
  gradient: { position: "absolute", left: 0, right: 0, bottom: 0, height: PAID_HERO_H },
  paidBadge: {
    position: "absolute",
    top: 14,
    left: 14,
  ...
  return (
    <View style={[styles.container, { paddingBottom: bottomInset }]}>
      ...
      <ScrollView style={styles.scroll} showsVerticalScrollIndicator={false}>
        ...
        {/* ── Jukebox Banner ── */}
        <Pressable style={styles.jukeBanner} onPress={() => router.push("/live" as any)}>
