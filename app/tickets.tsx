...
const PACKS = [
  ...
  { id: "pack-1200", tickets: 1200, priceUSD: 10.00, label: "1,200 Tickets", bonus: "20% bonus",   popular: false },
  { id: "pack-3000", tickets: 3000, priceUSD: 25.00, label: "3,000 Tickets", bonus: "Best value",  popular: false },
] as const;
